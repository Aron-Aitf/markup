...
TRACE enables a malicious party to steal information including Cookies, and possibly website credentials via XSS (cross-site scripting).
...
**418** - [I'm a teapot (1998 April Fools' joke)](https://developer.mozilla.org/en-US/docs/Web/HTTP/Status/418) :laughing: :tea:
